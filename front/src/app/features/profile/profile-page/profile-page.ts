...
export class ProfilePage implements OnInit {
  ...
  loadTopics() {
    this.topicsApiService.getTopicsForUser().subscribe(
      (topics) => this.topicsList.set(topics))
  }

  unsubscribeFromTopic(topicId:number) {
      this.topicsApiService.unsubscribeFromTopic(topicId).subscribe(
        () => {
          this.topicsList.update(topics =>
  ...
  protected readonly getPasswordErrorMessage = getPasswordErrorMessage;
}
